  ...
  try {
    ...
    await env.DB.prepare(
      `INSERT INTO users (id, username, email, password_hash, created_at)
       VALUES (?, ?, ?, ?, ?)`
    ).bind(id, cleanUsername, cleanEmail, hashHex, createdAt).run();
    return new Response(
      JSON.stringify({
        id,
...
// ../.wrangler/tmp/pages-EZ2D4t/functionsRoutes-0.8590833878623001.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-DG7oun/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-DG7oun/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8551791391150464.mjs.map
